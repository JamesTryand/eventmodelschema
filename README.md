...
`eventModelingSchemaVersion` `2.5.0` — see `CHANGELOG.md` for what changed since
...
`requiredOwnership`, `scope`). A companion lint tool remains future work. Structural validation only — see
